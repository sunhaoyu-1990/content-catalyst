...
示例:
  python copy_to_clipboard.py text "Hello, 领英!"
  python copy_to_clipboard.py title "AI 转型"
  python copy_to_clipboard.py content "根据最新报告..."

发布流程:
  1. 使用本工具复制标题和正文
  2. 访问 https://www.linkedin.com
  3. 粘贴内容到发布框
  4. 添加话题标签
  5. 点击发布
""")
...
def main():
    ...
    if command == 'title':
        ...
        print(f"已复制标题: {processed}")
    elif command == 'content':
        # 正文格式化
        processed = text.strip()
        print(f"已复制正文 ({len(processed)} 字)")
    else:
        # 直接复制
        processed = text
        print(f"已复制到剪贴板")
    ...
    if success:
        print("\n下一步:")
        print("1. 访问 https://www.linkedin.com")
        print("2. 粘贴内容")
        print("3. 添加话题标签")
        print("4. 点击发布")
        sys.exit(0)
