...
```
加载X/Twitter创作者Profile规范：
1. Read ../../profiles/content-creator-common.md
   → 应用通用创作规范（核心原则、质量标准、图片规范）
2. Read ../../profiles/x-twitter-creator.md
   → 应用X特定规范（简洁有力、观点鲜明、易于传播）

确保生成内容符合：
✅ Profile的核心原则（真实性、用户价值、平台适配）
✅ Profile的内容质量标准（影响力、相关性、时效性）
✅ Profile的格式规范（推文长度、线程结构、标签使用）
✅ Profile的语言风格要求（简洁有力、观点鲜明、短句为主）
```
